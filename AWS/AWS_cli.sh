...
aws --profile tr-fr-sandbox ec2 describe-instances
or
export aws_DEFAULT_PROFILE=tr-fr-sandbox


tr:application-asset-insight-id
501138

tr:resource-owner-role-id
AROAICZIAIJVTUXN3X3JQ

tr:resource-owner
yong.liu1@thomsonreuters.com
...
cloud-tool:
https://git.sami.int.thomsonreuters.com/enterprise-cloud/cloud-tool/wikis/Mac%20install
https://thehub.thomsonreuters.com/docs/DOC-2488513

$ cloud-tool check-updates


/Users/yongliu/.aws/credentials 


aws configuration file /Users/yongliu/.aws/credentials under the tr-fr-sandbox profile
cloud-tool configure
cloud-tool login

MGMT\M0122340@mgmt.tlrg.com

bjEjvLun188188!

aws_access_key_id = ASIAI75FI2GLCM3U57LA
aws_secret_access_key = b7NMvV0JuZYb2bCKbD6PALZXvMStVOzqEKX9uyPF


export aws_ACCESS_KEY_ID=ASIAJVU6RRT5B5WQMP4Q
export aws_SECRET_ACCESS_KEY=Locf9P0KfdQvspU/Kxmk3lbtTa9vCMcqTlgn/wW/
